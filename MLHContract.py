...
bytecode = compiled_sol['contracts']['MLHtoken.sol']['MLHtoken']['evm']['bytecode']['object']
abi = json.loads(compiled_sol['contracts']['MLHtoken.sol']['MLHtoken']['metadata'])['output']['abi']
W3 = Web3(WebsocketProvider('wss://ropsten.infura.io/ws/v3/%s'%infuraKey))
account1=Account.from_key(privateKey);
address1=account1.address

greeter = W3.eth.contract(
  address= "0x4b0a0fD9a6Eed86505145091b8df50d7713A9265",
  abi=abi
)
