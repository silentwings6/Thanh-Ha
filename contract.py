...
bytecode = compiled_sol['contracts']['token.sol']['XYZToken']['evm']['bytecode']['object']
abi = json.loads(compiled_sol['contracts']['token.sol']['XYZToken']['metadata'])['output']['abi']
W3 = Web3(WebsocketProvider('wss://ropsten.infura.io/ws/v3/%s'%infuraKey))
account1=Account.from_key(privateKey);
address1=account1.address

greeter = W3.eth.contract(
  address= "0x812c10C375f55865Ad144F7041F02DB82B7B862d",
  abi=abi
)
