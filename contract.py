...
bytecode = compiled_sol['contracts']['CBAtoken.sol']['CBAtoken']['evm']['bytecode']['object']
abi = json.loads(compiled_sol['contracts']['CBAtoken.sol']['CBAtoken']['metadata'])['output']['abi']
W3 = Web3(WebsocketProvider('wss://ropsten.infura.io/ws/v3/%s'%infuraKey))
account1=Account.from_key(privateKey);
address1=account1.address

greeter = W3.eth.contract(
  address= "0xa2CfE2A78B0cA193F58e0B1a2d38e0ffA769D8aD",
  abi=abi
)
